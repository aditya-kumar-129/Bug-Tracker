          ...
          <Modal open={openModal} onClose={handleModalClose}>
            <Box sx={style}>
              ...
              <input
                ...
                onChange={(input) => setBugDescription(input.target.value)}
                required
              />
              <br />
              ...
              <select
                required
                value={bugSeverity}
                onChange={(input) => setBugSeverity(input.target.value)}
              >
              ...
              <input
                ...
                required
              />
              <button className="green-btn" onClick={handleEditBugSubmit}>
                Update
              </button>
            </Box>
          </Modal>
